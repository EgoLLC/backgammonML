...
object NetworkUtil {
    ...
    * -----|-------|-----------|------|------|-------|-------|
    *  360 |   1   |    92_000 |  1.1 |  4.4 |  i7   | NStep |
    *  360 |   2   |    92_000 |  1.3 |  3.4 |  i7   | NStep |
    *  360 |   3   |    92_000 |  2.2 |  2.8 |  i7   | NStep |
    *  360 |   1   |   920_000 | 12.0 |  8.8 |  i7   | NStep |
    *  360 |   2   |   920_000 | 26.0 |  7.1 |  i7   | NStep |
    *  360 |   1   | 4_600_000 |   80 | 11.3 |  i7   | NStep |
    *  360 |   2   | 4_600_000 |   90 |  8.2 |  i7   | NStep |
    * -----|-------|-----------|------|------|-------|-------|
    * 1080 |   1   |    92_000 |  2.2 |  0.0 | CPUe5 | NStep |
    * 1080 |   1   |    92_000 |  2.4 |  2.9 |  i7   |  A3C  |
    * 1080 |   1   |    92_000 |  3.0 |  3.8 |  i7   | NStep |
    * 1080 |   1   |    92_000 |  3.2 |  4.2 |  M40  | NStep |
    * 1080 |   1   |    92_000 |  4.4 |  3.8 | 750Ti | NStep |
    * 1080 |   1   |    92_000 |  7.4 |  3.1 |   M4  |  A3C  |
    * -----|-------|-----------|------|------|-------|-------|
    * 1080 |   2   |    92_000 |  3.2 |  0.0 | CPUe5 | NStep |
    * 1080 |   2   |    92_000 |  4.2 |  2.9 |  M40  | NStep |
    * 1080 |   2   |    92_000 |  5.2 |  2.5 |  i7   | NStep |
    * 1080 |   2   |    92_000 |  7.0 |  2.5 | 750Ti | NStep |
    * -----|-------|-----------|------|------|-------|-------|
    * 1080 |   1   |   920_000 |   23 | 22.0 |  i7   |  A3C  |
    * 1080 |   1   |   920_000 |   25 | 23.3 | CPUe5 |  A3C  |
    * 1080 |   1   |   920_000 |   28 |  8.7 |  i7   | NStep |
    * 1080 |   1   |   920_000 |   32 |  9.9 |  M40  | NStep |
    * 1080 |   1   |   920_000 |   34 |  9.6 | CPUe5 | NStep |
    * 1080 |   1   |   920_000 |   48 | 10.6 | 750Ti | NStep |
    * -----|-------|-----------|------|------|-------|-------|
    * 1080 |   2   |   920_000 |   33 | 20.2 |  i7   |  A3C  |
    * 1080 |   2   |   920_000 |   35 | 20.4 | CPUe5 |  A3C  |
    * 1080 |   2   |   920_000 |   63 |  3.5 |  i7   | NStep |
    * -----|-------|-----------|------|------|-------|-------|
    * 1080 |   1   | 4_600_000 |  119 | 43.4 |  i7   |  A3C  |
    * 1080 |   1   | 4_600_000 |  124 | 43.1 | CPUe5 |  A3C  |
    * 1080 |   1   | 4_600_000 |  145 | 12.3 |  M40  | NStep |
    * 1080 |   1   | 4_600_000 |  200 | 11.9 |  i7   | NStep |
    * 1080 |   1   | 4_600_000 |  282 | 44.2 |  M40  |  A3C  |
    * -----|-------|-----------|------|------|-------|-------|
    * 1080 |   2   | 4_600_000 |  416 |  6.6 |  i7   | NStep |
    * */
